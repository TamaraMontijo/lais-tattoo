...
function AboutMe() {
  return (
    <div className="lg:flex lg:flex-row md:h-screen w-full max-md:relative max-md:top-32 max-md:h-[150vh]">
      <div className="lg:h-full bg-gray-900 md:w-1/2 relative">
        <div className="image absolute inset-0 max-md:top-[115px] max-lg:top-[180px] max-lg:left-0 max-md:w-[260px] md:w-full max-md:h-[355px] md:h-[50vh] lg:h-full">
          <Image
            src="/sobre.png"
      ...
      <div className="h-full lg:w-1/2 bg-[#817d7d]">
        <div className="relative max-lg:left-[30%]">
          <h1 className="font-crimson font-semibold text-[3rem] max-md:leading-9 md:text-4xl lg:text-5xl max-md:text-center text-white absolute lg:-left-1/4 max-md:top-56 top-48 max-md:w-[70%]">
