...
function MyWork() {
  return (
    <div>
      {/* LARGE SCREEN */}
    <div className="bg-palette-50 lg:w-screen h-[120vh] relative md:max-lg:flex md:max-lg:items-center md:max-lg:justify-center">
        ...
        <div className="flex md:max-lg:items-center">
          <div className="image md:w-[400px]">
            <Image
              ...
              className="object-fit md:translate-x-[-30%] lg:translate-y-[20%]"
              alt="Imagem tatuagem de flor"
              width={800}
              height={500}
            />
          </div>
          <div className="text w-[330px] lg:translate-y-[10%] h-auto">
            ...
            <p className="font-montserrat font-light leading-[1.8] tracking-widest text-base text-justify  md:max-lg:w-[390px]">
