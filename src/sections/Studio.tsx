...
function Studio() {
  return (
    <div>
      <div className="bg-[#817d7d] w-screen pt-8 pb-[16rem] md:max-lg:pb-[30rem] lg:py-24 relative">
        {/* left column */}
        <div className="w-3/4 lg:w-1/3 left-4 lg:left-40 top-1/4 relative">
          ...
          <span className="w-0.5 h-[26rem] md:h-80 lg:h-[54rem] bg-[#333333] rounded-full block absolute top-[4.75rem] left-[4rem]"></span>
          {/* end of circle and line decoration */}
          
          {/* Map */}
          <div className="max-lg:hidden mt-32 bg-palette-300 flex items-center justify-center p-16">
            <Map></Map>
          </div>
        </div>
        {/* image */}
        <div className="absolute flex flex-col max-lg:left-[5rem] top-[45%] md:max-lg:top-[25%] lg:top-1/4 lg:left-1/2 lg:translate-y-[-50%] w-[60vw] lg:w-[30vw] h-[85vh]">
          <Image
            src="/studio2.jpg"
            ...
            height={500}
          />
          <p className="mt-28 md:max-lg:mt-40 lg:mt-[400px] text-white font-montserrat text-base tracking-widest">Edifício Executive Office Tower</p>
      ...
      <div className="bg-palette-300 w-screen flex p-8 lg:hidden md:flex md:justify-center">
        <Map></Map>
      </div>
    </div>
